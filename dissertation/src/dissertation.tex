...
%such as removing the explicit bit reversal permutation
...
% - Two pass approach for Horizontal and Vertical passes
...
% FIXME: This english phrasing is not very great, rewrite later
