...
As mentioned on the former section, the stockham algorithm comes to save us from the bit reversal step, it miraculously does this for us by taking advantage of a reordering of the elements such as \autoref{fig:dif-elements-composition}.
