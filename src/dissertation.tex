...
The substitution variable \(\omega\) allows us o avoid writing extensive exponents

The symbol \(W\) represents the transformation matrix of the Discrete Fourier Transform, also called DFT matrix
This matrix multiplication form represents a more efficient way to compute the DFT in hardware.  
